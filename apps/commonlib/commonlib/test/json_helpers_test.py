...
def test_fixJsonInvalidAttribute_merged_fields():
    malformed = '{"salary": "50000 euros, modality": "REMOTE"}'
    fixed = fixJsonInvalidAttribute(malformed)
    assert '"salary": "50000 euros"' in fixed
    assert '"modality": "REMOTE"' in fixed
