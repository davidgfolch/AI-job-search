...
class TestCadencyResolution:
    ...
    @pytest.fixture
    def calculator(self):
        # We need a dummy name and properties for the calculator
        return ScrapperStateCalculator('Infojobs', {}, MagicMock())
    ...
    def test_resolve_timer(self, calculator, current_hour, env_vars, default_timer, expected_timer, expected_range):
    ...
    def test_resolve_timer_error(self, calculator, env_vars):
        with patch('scrapper.core.scrapper_state_calculator.getEnvByPrefix', return_value=env_vars):
