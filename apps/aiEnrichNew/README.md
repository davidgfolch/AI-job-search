...
This module performs AI-based enrichment of job data (extracting technologies, salary, etc.) using **local Hugging Face models** directly via the `transformers` library.
