...
from commonlib.mysqlUtil import DB_FIELDS_BOOL
from .util.stUtil import sortFields, stripFields
...
FF_KEY_CONFIG_PILLS = 'configPills'
# FORM KEYS, must have prefix 'form*'
