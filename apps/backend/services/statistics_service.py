...
class StatisticsService:
    ...
    def get_history_stats(self, start_date: str = None, end_date: str = None) -> List[Dict[str, Any]]:
    ...
    def get_sources_by_date(self, start_date: str = None, end_date: str = None) -> List[Dict[str, Any]]:
        df = self.repo.get_sources_by_date_df(start_date=start_date, end_date=end_date)
        return df.to_dict(orient='records')

    def get_sources_by_hour(self, start_date: str = None, end_date: str = None) -> List[Dict[str, Any]]:
        df = self.repo.get_sources_by_hour_df(start_date=start_date, end_date=end_date)
        return df.to_dict(orient='records')

    def get_sources_by_weekday(self, start_date: str = None, end_date: str = None) -> list[dict]:
        df = self.repo.get_sources_by_weekday_df(start_date=start_date, end_date=end_date)
        return df.to_dict(orient='records')
