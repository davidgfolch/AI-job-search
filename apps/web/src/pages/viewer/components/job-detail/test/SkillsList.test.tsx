...
import * as useLearnListHook from '../../../../skillsManager/hooks/useLearnList';

// Mock the EditSkillModal to avoid rendering the complex modal and simplify testing
vi.mock('../../../../skillsManager/components/EditSkillModal', () => ({
...
vi.mock('../../../../skillsManager/hooks/useLearnList', () => ({
    useLearnList: vi.fn(() => ({
...
describe('SkillsList', () => {
    ...
    it('navigates through database skills with case-insensitivity and unique normalized names', () => {
        ...
        // Update mock implementation for this specific test case
    // Update mock implementation for this specific test case
        (useLearnListHook.useLearnList as unknown as ReturnType<typeof vi.fn>).mockReturnValue({
            learnList: dbSkills,
            saveSkill: mockSaveSkill,
            toggleSkill: mockToggleSkill,
