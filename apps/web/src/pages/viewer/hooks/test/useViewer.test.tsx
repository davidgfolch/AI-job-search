...
describe('useViewer', () => {
    ...
    it('should NOT write stale data (page mismatch) into allJobs', () => {
        ...
        // List may be cleared to [] on mount, but never filled with mismatched stale data
        expect(mockSetAllJobs).not.toHaveBeenCalledWith([{ id: 100 }]);
