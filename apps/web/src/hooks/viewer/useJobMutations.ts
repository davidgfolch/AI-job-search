...
interface UseJobMutationsProps {
    ...
    activeTab: TabType;
    autoSelectNext: React.MutableRefObject<{ shouldSelect: boolean; previousJobId: number | null }>;
    selectedIds: Set<number>;
    setSelectedIds: React.Dispatch<React.SetStateAction<Set<number>>>;
    selectionMode: 'none' | 'manual' | 'all';
    setSelectionMode: React.Dispatch<React.SetStateAction<'none' | 'manual' | 'all'>>;
}
