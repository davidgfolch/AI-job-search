...
from commonlib.ai_helpers import combineTaskResults, footer, mapJob, printJob, validateResult, RETRY_ERROR_PREFIX, MAX_AI_ENRICH_ERROR_LEN
...
def _process_job_safe(repo: AiEnrichRepository, crew: Crew, id: int, total: int, idx: int, process_name: str):
    global totalCount, jobErrors
    printHR(yellow)
    stopWatch.start()
