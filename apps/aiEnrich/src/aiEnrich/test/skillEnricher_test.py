...
@patch('aiEnrich.skillEnricher.query_ollama')
@pytest.mark.parametrize("ollama_output, expected_description, expected_category", [
...
def test_generate_skill_description(mock_ollama, ollama_output, expected_description, expected_category):
    mock_ollama.return_value = ollama_output
