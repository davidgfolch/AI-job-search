...
class TestJobService:
    def test_get_job_by_id_valid(self):
        ...
        mock_repo.findById.return_value = mock_job
        
        service = JobService(mock_repo)
        result = service.getJobById(1)
        
        assert result == mock_job
        mock_repo.findById.assert_called_once_with(1)
    ...
    def test_search_jobs(self):
        ...
        result = service.searchJobs(filters)
        
        assert result == mock_jobs
        mock_repo.findAll.assert_called_once_with(filters)
    ...
    def test_delete_job_not_found(self):
        mock_repo = Mock(spec=JobRepository)
        mock_repo.findById.return_value = None
    ...
    def test_update_job_status_valid(self):
        ...
        result = service.updateJobStatus(1, status_fields)
    ...
    def test_update_job_status_invalid_field(self):
        ...
        with pytest.raises(ValueError, match="Invalid status field: invalid_field"):
            service.updateJobStatus(1, status_fields)